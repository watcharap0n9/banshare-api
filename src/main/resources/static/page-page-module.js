...
var ViewDetailComponent = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fileText += 'จ่ายแบบ: ' + this.listData.paymentType.find(function (event) { return event.paymentTypeId === item.paymentType; }).paymentTypeDesc + '<BR>';
    ...
    ViewDetailComponent.prototype.close = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var cf;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.onClickDialog('ยืนยันปิดบัญชี')];
                    case 1:
                        cf = _a.sent();
                        if (cf) {
                            this.SpinnerService.show();
